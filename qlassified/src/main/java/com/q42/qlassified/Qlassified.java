...
public enum Qlassified {
    ...
    public boolean instanceCheck() {
        return classifiedFactory.instanceCheck();
    }

    public void forceCreateKey(Context context) {
        classifiedFactory.forceCreateKey(context);
    }
    ...
    public void setStorageService(@NonNull QlassifiedStorageService service) {
        if(service == null) {
            Utility.logError(Qlassified.class.getSimpleName(), "Storage service prodided is null");
            return;
        }
    ...
    public Boolean getBoolean(@NonNull String key) throws UnrecoverableEntryException, NoSuchAlgorithmException, KeyStoreException, IllegalBlockSizeException, NoSuchPaddingException, BadPaddingException, NoSuchProviderException, InvalidKeyException {
        return classifiedFactory.getBoolean(key);
    }

    public Float getFloat(@NonNull String key) throws UnrecoverableEntryException, NoSuchAlgorithmException, KeyStoreException, IllegalBlockSizeException, NoSuchPaddingException, BadPaddingException, NoSuchProviderException, InvalidKeyException {
        return classifiedFactory.getFloat(key);
    }

    public Integer getInt(@NonNull String key) throws UnrecoverableEntryException, NoSuchAlgorithmException, KeyStoreException, IllegalBlockSizeException, NoSuchPaddingException, BadPaddingException, NoSuchProviderException, InvalidKeyException {
        return classifiedFactory.getInt(key);
    }

    public Long getLong(@NonNull String key) throws UnrecoverableEntryException, NoSuchAlgorithmException, KeyStoreException, IllegalBlockSizeException, NoSuchPaddingException, BadPaddingException, NoSuchProviderException, InvalidKeyException {
        return classifiedFactory.getLong(key);
    }

    public String getString(@NonNull String key) throws UnrecoverableEntryException, NoSuchAlgorithmException, KeyStoreException, IllegalBlockSizeException, NoSuchPaddingException, BadPaddingException, NoSuchProviderException, InvalidKeyException {
        return classifiedFactory.getString(key);
    }

    public Serializable getSerializable(@NonNull String key) throws UnrecoverableEntryException, NoSuchAlgorithmException, KeyStoreException, IllegalBlockSizeException, NoSuchPaddingException, BadPaddingException, NoSuchProviderException, InvalidKeyException {
