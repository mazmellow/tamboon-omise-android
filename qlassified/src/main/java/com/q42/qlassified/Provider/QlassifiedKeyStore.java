...
public class QlassifiedKeyStore implements QlassifiedSecurity {
    ...
    public void createKeys() throws
        ...
        Utility.logDebug(Utility.LOG_TAG_KEYSTORE, String.format("Public key: %s", keyPair.getPublic()));
        Utility.logDebug(Utility.LOG_TAG_KEYSTORE, String.format("Private key: %s", keyPair.getPrivate()));
    }
    ...
    public QlassifiedEntry decryptEntry(EncryptedEntry entry) throws UnrecoverableEntryException, NoSuchAlgorithmException, KeyStoreException, InvalidKeyException, BadPaddingException, NoSuchProviderException, IllegalBlockSizeException, NoSuchPaddingException {
    ...
    private boolean checkKeyAvailability() {
        ...
        try {
            ...
            Utility.logDebug(Utility.LOG_TAG_KEYSTORE, String.format("Could not create a KeyStore instance. Stacktrace: %s", e));
            return false;
        }
    }
    ...
    private String encrypt(String input) {
        ...
        try {
            ...
            return crypto.encrypt(input, publicKey);
                ...
                KeyStoreException e) {
            Utility.logError(Utility.LOG_TAG_KEYSTORE, String.format("Could not encrypt this string. Stacktrace: %s", e));
            return null;
        }
    }

    private String decrypt(String input) throws UnrecoverableEntryException, NoSuchAlgorithmException, KeyStoreException, IllegalBlockSizeException, InvalidKeyException, BadPaddingException, NoSuchProviderException, NoSuchPaddingException {
        ...
        try {
            ...
            Utility.logError(Utility.LOG_TAG_KEYSTORE, String.format("Could not decrypt this string. Stacktrace: %s", e));
            throw e;
        }
    }
}
